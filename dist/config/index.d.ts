...
export interface DefaultContainerProps<F extends FieldValues = FieldValues, Q extends QueriesArray = QueriesArray> {
...
export declare let pageConfig: PageConfigProps;
export declare const setPageConfig: (config: Partial<PageConfigProps>) => void;
